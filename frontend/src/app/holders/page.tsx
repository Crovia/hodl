...
const presaleParticipants = [
  ...
  { address: '0xC3F1087176485Ec5518cbC88169205fF26f75702', allocation: 1000 },
...
const TOTAL_PRESALE_CRO = presaleParticipants.reduce((s, p) => s + p.allocation, 0);
const PRESALE_SUPPLY_PCT = 38.4;
