...
export default function Header() {
  ...
  return (
    <header className="relative z-20 overflow-hidden bg-[#0a0a0a]">
      ...
      <nav className="relative max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <button className="px-5 py-2 rounded-full bg-gradient-to-r from-gold-500 to-gold-600 text-black font-bold text-sm hover:from-gold-400 hover:to-gold-500 transition-all hover:shadow-[0_0_20px_rgba(251,191,36,0.4)]">
          Buy $HODL
        </button>
      </nav>
    </header>
