  ...
  return (
    <div className="relative py-24 px-6">
      <div className="relative max-w-5xl mx-auto">
        ...
        {/* How to Participate */}
        <div className="glass-card rounded-2xl overflow-hidden mb-12 border border-gold-400/20">
          <div className="p-6 border-b border-gold-400/10">
            <h2 className="text-2xl font-bold diamond-text">How to Participate</h2>
          </div>
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="text-center p-4">
                <div className="w-10 h-10 rounded-full bg-gold-400/10 border border-gold-400/30 flex items-center justify-center mx-auto mb-3">
                  <span className="text-gold-400 font-black text-lg">1</span>
                </div>
                <h4 className="text-sm font-bold text-white mb-1">Verify in Discord</h4>
                <p className="text-xs text-gray-500">Join Cronos Legends Discord and verify your wallet with a moderator</p>
              </div>
              <div className="text-center p-4">
                <div className="w-10 h-10 rounded-full bg-gold-400/10 border border-gold-400/30 flex items-center justify-center mx-auto mb-3">
                  <span className="text-gold-400 font-black text-lg">2</span>
                </div>
                <h4 className="text-sm font-bold text-white mb-1">Send CRO</h4>
                <p className="text-xs text-gray-500">Send your contribution to the presale wallet below</p>
              </div>
              <div className="text-center p-4">
                <div className="w-10 h-10 rounded-full bg-gold-400/10 border border-gold-400/30 flex items-center justify-center mx-auto mb-3">
                  <span className="text-gold-400 font-black text-lg">3</span>
                </div>
                <h4 className="text-sm font-bold text-white mb-1">Get Listed</h4>
                <p className="text-xs text-gray-500">Once verified, you will be manually added to the participants list</p>
              </div>
            </div>

            {/* Presale wallet */}
            <div className="bg-black/40 rounded-xl p-5 border border-gold-400/20">
              <div className="text-xs text-gray-500 uppercase tracking-wider font-bold mb-2">Presale Wallet</div>
              <div className="flex items-center gap-3 flex-wrap">
                <a
                  href="https://cronoscan.com/address/0xAF87e4Df58D735ec2971d2D8Db663B02cA60175D#tokentxns"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-mono text-sm md:text-base text-gold-400 hover:text-gold-300 transition-colors break-all"
                >
                  0xAF87e4Df58D735ec2971d2D8Db663B02cA60175D
                </a>
                <CopyButton text="0xAF87e4Df58D735ec2971d2D8Db663B02cA60175D" />
              </div>
            </div>
            ...
            <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="flex items-center gap-2 p-3 rounded-lg bg-red-500/5 border border-red-500/10">
                ...
                <span className="text-xs text-gray-400">1 participation per person</span>
              </div>
              <div className="flex items-center gap-2 p-3 rounded-lg bg-red-500/5 border border-red-500/10">
                <svg className="w-4 h-4 text-red-400 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
                  <circle cx="12" cy="12" r="10" />
                ...
                <span className="text-xs text-gray-400">No double wallets</span>
              </div>
              <div className="flex items-center gap-2 p-3 rounded-lg bg-green-500/5 border border-green-500/10">
                ...
                <span className="text-xs text-gray-400">Must verify in Discord</span>
              </div>
            </div>
          </div>
        </div>
